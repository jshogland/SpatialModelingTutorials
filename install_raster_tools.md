...
3. Download this yml file <a href="./rstools10.yml" download>Click to Download</a> and store it within your documents folder in a location you can access (e.g., ./documents/raster_tools_setup/rstools10.yml
4. Type in conda env create -f \<the path to the yml file\>. For me the command would be conda create -f ./documents/raster_tools_setup/rstools10.yml
5. Press the Enter button and Raster-Tools will be installed within the rstools10 environment

To launch Jupyter Lab type the following commands:
- conda activate rstools10
- jupyter lab
